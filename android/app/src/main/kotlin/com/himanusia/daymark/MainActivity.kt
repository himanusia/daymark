...
class MainActivity : FlutterActivity() {
    companion object {
        private const val CALENDAR_CHANNEL = "daymark/calendar"
        private const val WIDGET_CHANNEL = "daymark/widget"
    ...
    private fun updateAllWidgets() {
        ...
        val component = ComponentName(this, DaymarkWidgetProvider::class.java)
        val ids = manager.getAppWidgetIds(component)
        if (ids.isNotEmpty()) {
            DaymarkWidgetProvider.updateAll(this, ids)
        }
    }
}

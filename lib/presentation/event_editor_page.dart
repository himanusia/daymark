...
class EventEditorPage extends StatefulWidget {
  ...
  final ItsTheDayEvent? initialEvent;
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text(
                "It's the Day! keeps this event on your device and counts from the local time shown below.",
  ...
  Future<void> _delete() async {
    final shouldDelete = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          "“${widget.initialEvent!.title}” will be removed from It's the Day!.",
        ),
        actions: [
          TextButton(
